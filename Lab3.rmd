...
m3 = lm(t$crmrte ~ t$density + t$prbarr + t$prbconv + t$taxpc)
m4 = lm(t$crmrte ~ t$prbarr + t$prbconv + t$density + t$taxpc + t$pctmin80 + t$pctymle)
m5 = lm(t$crmrte ~ t$prbarr + t$prbconv + t$prbpris + t$avgsen + t$density + t$taxpc + t$pctmin80 + t$mix + t$pctymle + t$wage)
